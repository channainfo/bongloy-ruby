...
Consumes the [Bongloy API](http://bongloy.com/documentation#bongloy_api_reference)
...
The [Bongloy API](http://bongloy.com/documentation#bongloy_api_reference) is described in detail with example CURL requests.

### Authentication

The environment variable `BONGLOY_SECRET_KEY` can be set to automatically configure Bongloy with your [API Key](http://bongloy.com/documentation/#bongloy_api_reference_authentication). For example:
...
Alternatively you can set your [API Key](http://bongloy.com/documentation/#bongloy_api_reference_authentication) each time when you create an API Resource. For example:
...
The following examples should actually work if you provide the correct credentials. Replace `sk_test_my_secret_api_key` with your own [Secret API Key](http://bongloy.com/documentation/#bongloy_api_reference_authentication).
...
See also [Bongloy API -> Charges -> Retrieve an existing charge](http://bongloy.com/documentation#bongloy_api_reference_charges_retrieve_charge)
...
See also [Bongloy API -> Customers](http://bongloy.com/documentation#bongloy_api_reference_customers)

#### Create a Customer

See also [Bongloy API -> Customers -> Create a new customer](http://bongloy.com/documentation#bongloy_api_reference_customers_create_customer)
...
See also [Bongloy API -> Customers -> Retrieve an existing customer](http://bongloy.com/documentation#bongloy_api_reference_customers_retrieve_customer)
...
See also [Bongloy API -> Customers -> Update an existing Customer](http://bongloy.com/documentation#bongloy_api_reference_customers_update_customer)
...
See also [Bongloy API -> Cards](http://bongloy.com/documentation#bongloy_api_reference_cards)

#### Create a Card (Attach a new Card to a Customer)

See also [Bongloy API -> Cards -> Create a new card](http://bongloy.com/documentation#bongloy_api_reference_cards_create_card)
...
See also [Bongloy API -> Cards -> Create an existing card](http://bongloy.com/documentation#bongloy_api_reference_cards_retrieve_card)
...
See also [Bongloy API -> Cards -> Update an existing card](http://bongloy.com/documentation#bongloy_api_reference_cards_update_card)
...
See also [Bongloy API -> Tokens](http://bongloy.com/documentation#bongloy_api_reference_tokens)

#### Create a Token

See also [Bongloy API -> Tokens -> Create a new token](http://bongloy.com/documentation#bongloy_api_reference_tokens_create_token)
